...
|---|---|---|---|
| 4.1 | Plan + Tracker land + `git mv` Step 04 docs → `legacy/step04/` + Progress Tracker stale-text cleanup | In progress | — |
| 4.2 | `schema/program.py` area-field realignment (S05-D1) + schema/serialize tests | Not started | — |
