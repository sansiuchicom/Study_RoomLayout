...
The atom grid should be fine enough for corridor/access control while avoiding
noisy fitted decimals in generated labels. The policy here treats 0.30m as a
target module, keeps most atom widths on a 0.05m quantum, and preserves exact
interval length after snapping to the geometry grid.
"""
