"""Leftover absorption helpers for room partition growth."""
...
from .geometry import rotate_radians as _rotate
from .growth_seed import _enumerate_cells_with_regions
