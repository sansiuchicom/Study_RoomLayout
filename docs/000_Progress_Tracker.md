...
pre-build Plan review + a 12-finding post-implementation review). **Merged
`--no-ff` to `main`** (`382966c`, 2026-06-10). 1020 pytest + 4 xfail (GEOS
3.14.1); ruff clean; apartment goldens byte-identical.
