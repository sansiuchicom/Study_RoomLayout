...
p2e = import_module('02e_improved')
p2h = import_module('02h_progressive')
p2i = import_module('02i_lir_progressive')
p2L = import_module('02L_final')
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/work/02M_per_family.png', dpi=110,
                bbox_inches='tight')
    print("\nsaved: 02M_per_family.png")
